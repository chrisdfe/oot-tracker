...
const FAIRY_FOUNTAINS_URL = `${ZELDA_DUNGEON_BASE_URL}/wiki/Ocarina_of_Time_Fairy_Fountains`;
const GREAT_FAIRY_FOUNTAINS_BASE_PATH = "great-fairy-fountains";
const GREAT_FAIRY_FOUNTAINS_JSON_FILENAME = "greatFairyFountains.json";
